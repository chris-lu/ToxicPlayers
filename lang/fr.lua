...
SafeAddString(TOXICPLAYERS_OPTION_RETICLE_TEXT_TOOLTIP,        "Si sélectionné, ToxicPlayers affichera le statut de ce joueur lorsqu'il sera ciblé (ignoré, muet, guilde ou ami)", 1)
SafeAddString(TOXICPLAYERS_OPTION_RETICLE_ICON_DESCRIPTION,    "Afficher une icône pour le joueur ciblé", 1)
SafeAddString(TOXICPLAYERS_OPTION_RETICLE_ICON_TOOLTIP,        "Si sélectionné, ToxicPlayers affichera une icône en dessous de la visée lorsqu'il sera ciblé (ignoré, muet, guilde ou ami)", 1)
